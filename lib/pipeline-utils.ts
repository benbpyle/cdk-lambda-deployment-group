...
export const getBucketConfig = (stage: StageEnvironment): BucketConfig => {
    if (stage === StageEnvironment.QA) {
        return {
            ...
            keyArn: 'arn:aws:kms:us-west-2:904442064295:key/1f1392d8-76e2-4187-a518-c9fd764c3f5b'
        }

    } else if (stage === StageEnvironment.PROD) {
        return {
            bucket: 'arn:aws:s3:::prod-dms-landing-curantis',
            keyArn: 'arn:aws:kms:us-west-2:904442064295:key/43ad8c42-da72-4edf-b8b8-3b91dc06bb17'
        }
    }
    return {
        bucket: 'arn:aws:s3:::dev-dms-landing-curantis',
        keyArn: 'arn:aws:kms:us-west-2:904442064295:key/362de9f7-08ce-415c-92c7-c5f903ea7724'
    }
}

export const getPipeline = (scope: Construct,
                            repos: IRepository,
                            options: Options,
                            branch: string,
                            region: string,
                            commands: string[]): CodePipeline => {
